...
export class ManufacturingTrimmingHydraulicForgingCalculatorService {
  constructor(
  ...
  public calculateTrimmingHydraulicForging(manufactureInfo: ProcessInfoDto, fieldColorsList: any, manufacturingObj: ProcessInfoDto): ProcessInfoDto {
