...
import { combineLatest, forkJoin, Subject, takeUntil, Observable, of } from 'rxjs';
...
import { CostManufacturingAutomationService } from '../automation/cost-manufacturing-automation.service';
...
import { CostToolingRecalculationService } from '../../services/automation/cost-tooling-recalculation.service';
              ...
              if (machineTypeObj && processInfo?.machineMarketId) {
                ...
                if (!alreadyProcessed) {
                  if (isSecondaryProcess && processInfo?.processTypeID !== ProcessType.Stage) {
                    ...
                    const processResult = this._plasticRubberService.calculationsForInjectionMoulding(processInfo, dirtyFields, selectedProcess);
                    if (processResult) {
                    ...
                    const processResult = this._plasticRubberService.calculationsForRubberInjectionMoulding(processInfo, dirtyFields, selectedProcess);
                    if (processResult) {
                      let isToolingAutomationRun = false;
                      processResult.processInfoId = selectedProcess.processInfoId;
                      if (
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForTransferMolding(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    processInfo.setUpTimeBatch = 60;
                    addProcessParams = {
                      processResult: this._plasticRubberService.doCostCalculationForThermoForming(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.doCostCalculationForVacuumForming(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForBlowMolding(processInfo, dirtyFields, selectedProcess, currentPart),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForCompressionMolding(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForCompressionMaterialPreparation(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForRubberExtrusion(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForManualDeflashing(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForPostCuring(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForPreform(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForCutting(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
                    ...
                    addProcessParams = {
                      processResult: this._plasticRubberService.calculationsForDeburring(processInfo, dirtyFields, selectedProcess),
                      totProcessList: calculateResults,
                      processInfoId: selectedProcess.processInfoId,
                      toolingEntryData: null,
                      selectedProcess: selectedProcess,
