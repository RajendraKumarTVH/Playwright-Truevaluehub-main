...
@Component({
  selector: 'app-custom-cable-process',
  templateUrl: './custom-cable-process.component.html',
  styleUrls: ['./custom-cable-process.component.scss'],
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, FieldCommentComponent, OnlyNumber, AutoTooltipDirective],
})
export class CustomCableProcessComponent {
