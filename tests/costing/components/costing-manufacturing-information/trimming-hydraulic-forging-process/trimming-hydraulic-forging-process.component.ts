...
@Component({
  selector: 'app-trimming-hydraulic-forging-process',
  ...
  templateUrl: './trimming-hydraulic-forging-process.component.html',
  styleUrl: './trimming-hydraulic-forging-process.component.scss',
  standalone: true,
})
export class TrimmingHydraulicForgingProcessComponent {
