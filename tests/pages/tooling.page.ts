...
export class ToolingPage extends BasePage {
    // Tool Details
    readonly ToolingName: Locator;
    readonly SourceCountry: Locator;
    readonly ToolLifeNoOfShots: Locator;
    readonly NoOfShotsNeededFromTool: Locator;

    // Sheet Metal specific
    readonly NoOfDieStages: Locator;
    readonly NoOfStagesAlong: Locator;
    readonly NoOfStagesAcross: Locator;
    readonly DieSizeLength: Locator;
    readonly DieSizeWidth: Locator;
    readonly DieSetSizeLength: Locator;
    readonly DieSetSizeWidth: Locator;
    readonly DieSetSizeHeight: Locator;

    // Common Tool counts
    readonly TotalNoOfTools: Locator;
    readonly NoOfNewTools: Locator;
    readonly NoOfSubsequentTools: Locator;

    // Plastic/Rubber specific
    readonly NoOfCavity: Locator;
    readonly NoOfCopperElectrodes: Locator;
    readonly NoOfGraphiteElectrodes: Locator;
    readonly CavityLength: Locator;
    readonly CavityWidth: Locator;
    readonly MouldType: Locator;
    readonly MouldSubType: Locator;
    readonly NoOfDrop: Locator;
    readonly MouldCriticality: Locator;
    readonly SurfaceFinish: Locator;
    readonly TextureGrade: Locator;

    // Envelope Dimensions
    readonly EnvelopeLength: Locator;
    readonly EnvelopeWidth: Locator;
    readonly EnvelopeHeight: Locator;

    // Gaps
    readonly RunnerGapLength: Locator;
    readonly RunnerGapWidth: Locator;
    readonly SideGapLength: Locator;
    readonly SideGapWidth: Locator;

    // Base Dimensions
    readonly MoldBaseLength: Locator;
    readonly MoldBaseWidth: Locator;
    readonly MoldBaseHeight: Locator;

    // Undercuts
    readonly ExternalSideCores: Locator;
    readonly InternalAngularSlides: Locator;
    readonly UndercutsUnscrewing: Locator;
