 ...
 * Converted from Angular source: src/app/modules/costing/costing.config.ts
 * For use in Playwright tests
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.CostingConfig = exports.MachineType = exports.PartComplexity = exports.PrimaryProcessType = exports.ProcessType = void 0;
// ==================== ENUMS ====================
var ProcessType;
(function (ProcessType) {
    ...
    ProcessType[ProcessType["SeamWelding"] = 218] = "SeamWelding";
    ProcessType[ProcessType["SubMergedArcWelding"] = 62] = "SubMergedArcWelding";
    ProcessType[ProcessType["Sonicwelding"] = 58] = "Sonicwelding";
    ...
    ProcessType[ProcessType["LaserWelding"] = 32] = "LaserWelding";
    ProcessType[ProcessType["Brazing"] = 220] = "Brazing";
...
class CostingConfig {
    ...
    weldingDefaultPercentage(processTypeId, partComplexity = 1, percentageType = 'yieldPercentage') {
        ...
        if (!config)
            return 0;
        const typeConfig = config[percentageType];
    ...
    loadingUnloadingTime(weight) {
        ...
        return ((_a = data.find((x) => x.fromWeight <= weight && x.toWeight >= weight)) === null || _a === void 0 ? void 0 : _a.time) || 5;
    }
    /**
