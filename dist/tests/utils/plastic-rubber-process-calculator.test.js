...
const plastic_rubber_process_calculator_1 = require("./plastic-rubber-process-calculator");
 ...
 */
test_1.test.describe('Plastic Rubber Process Calculator Tests', () => {
    const calculator = new plastic_rubber_process_calculator_1.PlasticRubberProcessCalculator();
    (0, test_1.test)('TC001: Injection Moulding Calculation', () => {
        // 1. Setup Input Data
        ...
        (0, test_1.expect)(result.cycleTime).toBeGreaterThan(0);
        (0, test_1.expect)(result.directMachineCost).toBeGreaterThan(0);
        (0, test_1.expect)(result.directLaborCost).toBeGreaterThan(0);
        ...
        (0, test_1.expect)(result.coolingTime).toBeGreaterThan(0);
    });
    (0, test_1.test)('TC002: Rubber Injection Moulding Calculation', () => {
        const manufactureInfo = {
        ...
        (0, test_1.expect)(result.sideCoreMechanisms).toBeGreaterThan(0);
    });
    (0, test_1.test)('TC003: Compression Molding Calculation', () => {
        const manufactureInfo = {
            processTypeID: constants_1.ProcessType.InjectionMoulding, // Using generic type if specific one not in enum
        ...
        (0, test_1.expect)(result.coolingTime).toBe(3);
        // pouringTime = 3 * noOfCavities = 3
        (0, test_1.expect)(result.pouringTime).toBe(3);
    });
});
