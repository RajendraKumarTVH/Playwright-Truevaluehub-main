...
exports.costingConfig = exports.CostingConfig = void 0;
...
class CostingConfig {
    ...
    weldingDefaultPercentage(processTypeId, partComplexity = 1, percentageType = 'yieldPercentage') {
        var _a, _b, _c, _d;
        const vals = [
            { processTypeId: constants_1.ProcessType.Sonicwelding, yieldPercentage: { 1: 98, 2: 97, 3: 96 }, samplingRate: { 1: 1.95, 2: 4, 3: 6 } },
            { processTypeId: constants_1.ProcessType.TigWelding, yieldPercentage: { 1: 98, 2: 96, 3: 94 }, samplingRate: { 1: 4, 2: 6, 3: 8 } },
            { processTypeId: constants_1.ProcessType.SpotWelding, yieldPercentage: { 1: 97, 2: 95, 3: 93 }, samplingRate: { 1: 4, 2: 6, 3: 8 } },
            { processTypeId: constants_1.ProcessType.SeamWelding, yieldPercentage: { 1: 97, 2: 95, 3: 93 }, samplingRate: { 1: 4, 2: 6, 3: 8 } },
            { processTypeId: constants_1.ProcessType.MigWelding, yieldPercentage: { 1: 97, 2: 95, 3: 93 }, samplingRate: { 1: 5, 2: 8, 3: 10 } },
            { processTypeId: constants_1.ProcessType.StickWelding, yieldPercentage: { 1: 97, 2: 95, 3: 93 }, samplingRate: { 1: 5, 2: 8, 3: 10 } },
            { processTypeId: constants_1.ProcessType.FrictionWelding, yieldPercentage: { 1: 97, 2: 95, 3: 93 }, samplingRate: { 1: 4, 2: 6, 3: 8 } }
        ];
        return ((_b = (_a = vals.find((x) => x.processTypeId === processTypeId)) === null || _a === void 0 ? void 0 : _a[percentageType]) === null || _b === void 0 ? void 0 : _b[partComplexity]) || ((_d = (_c = vals[4]) === null || _c === void 0 ? void 0 : _c[percentageType]) === null || _d === void 0 ? void 0 : _d[partComplexity]);
    }
    ...
    noOfTrackWeld(len) {
        ...
        return ((_a = weldList.find((x) => x.toLength >= len)) === null || _a === void 0 ? void 0 : _a.noOfWeld) || weldList[weldList.length - 1].noOfWeld;
    }
    weldPass(len, weldType = 'welding') {
        ...
        return ((_a = weldList.find((x) => x.toWeldLegLength >= len)) === null || _a === void 0 ? void 0 : _a.noOfWeldPasses) || weldList[weldList.length - 1].noOfWeldPasses;
    }
...
exports.costingConfig = new CostingConfig();
