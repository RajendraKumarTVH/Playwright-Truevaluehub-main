...
class MigWeldingLogic {
    ...
    gatherManufacturingInfo(processType, machineEfficiency, density) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // ───────────────────────────────
            // 1️⃣ Manufacturing fields
            // ───────────────────────────────
            const [machineHourRate, // 0
            machineEfficiencyUI, // 1
            lowSkilledLaborRatePerHour, // 2
            noOfLowSkilledLabours, // 3
            noOfSkilledLabours, // 4
            skilledLaborRatePerHour, // 5
            electricityUnitCost, // 6
            powerConsumption, // 7
            yieldPer, // 8
            annualVolume, // 9
            setUpTime, // 10
            qaOfInspectorRate, // 11
            inspectionTime, // 12
            samplingRate, // 13
            netMaterialCost, // 14
            cycleTime, // 15
            ...
            weldLegLength, // 17
            weldElementSize, // 18
            PartReorientationTime, // 19
            partProjectedArea, // 20
            cuttingLength, // 21
            travelSpeed, // 22
            UnloadingTime, // 23
            semiAutoOrAuto, // 24
            ...
            selectedVoltage, // 29
            passesLocator // 30
            ] = yield this.readManufacturingInputs();
            // ───────────────────────────────
            // 2️⃣ Lot size
            // ───────────────────────────────
