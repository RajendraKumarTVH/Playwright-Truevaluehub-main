...
class WeldingCalculator {
    ...
    weldingCommonCalc(manufactureInfo, fieldColorsList, manufacturingObj, laborRateDto) {
        ...
        const calculatedInspectionCost = this.weldingMode === 'seamWelding'
            ...
            : this.shareService.isValidNumber(((((_d = manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.qaOfInspectorRate) !== null && _d !== void 0 ? _d : 0) / 60) *
                Math.ceil((((_e = manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.samplingRate) !== null && _e !== void 0 ? _e : 0) / 100) * ((_f = manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.lotSize) !== null && _f !== void 0 ? _f : 0)) *
    ...
    calculationsForWeldingPreparation(manufactureInfo, fieldColorsList, manufacturingObj) {
        ...
        if (manufactureInfo.isdirectMachineCostDirty && manufactureInfo.directMachineCost != null) {
            ...
            logger.info(`   Direct Machine Cost: ${this.shareService.isValidNumber((Number(manufactureInfo.machineHourRate) * Number(manufactureInfo.cycleTime)) / 3600 / efficiency)}`);
        ...
        if (manufactureInfo.isdirectSetUpCostDirty && manufactureInfo.directSetUpCost != null) {
            ...
            let directSetUpCost = this.shareService.isValidNumber(((((Number(manufactureInfo.noOfLowSkilledLabours) * Number(manufactureInfo.setUpTime)) / 60) * Number(manufactureInfo.lowSkilledLaborRatePerHour)) / efficiency / Number(manufactureInfo.lotSize)) +
        ...
        if (manufactureInfo.isdirectLaborCostDirty && manufactureInfo.directLaborCost != null) {
            ...
            let directLaborCost = this.shareService.isValidNumber((Number(manufactureInfo.noOfLowSkilledLabours) * Number(manufactureInfo.lowSkilledLaborRatePerHour) * Number(manufactureInfo.cycleTime)) / 3600 / efficiency +
        ...
        if (manufactureInfo.isinspectionCostDirty && manufactureInfo.inspectionCost != null) {
            ...
            let inspectionCost = this.shareService.isValidNumber(((manufactureInfo.inspectionTime / 60) * (Number(manufactureInfo.qaOfInspector) || 1) * Number(manufactureInfo.qaOfInspectorRate)) /
                efficiency /
                Number(manufactureInfo.lotSize));
