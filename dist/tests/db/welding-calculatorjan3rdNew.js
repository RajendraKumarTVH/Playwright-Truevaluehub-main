...
class WeldingCalculator {
    ...
    constructor() {
        ...
        this.safeDiv = (numerator, a, b) => (a && b ? numerator / (a * b) : 0);
    ...
    calculationsForWeldingPreparation(manufactureInfo, fieldColorsList, manufacturingObj) {
        ...
        const weldingLength = ((_a = manufactureInfo.materialInfoList) === null || _a === void 0 ? void 0 : _a.length) > 0 ? (_b = manufactureInfo.materialInfoList[0]) === null || _b === void 0 ? void 0 : _b.dimX : 0;
        const weldingWidth = ((_c = manufactureInfo.materialInfoList) === null || _c === void 0 ? void 0 : _c.length) > 0 ? (_d = manufactureInfo.materialInfoList[0]) === null || _d === void 0 ? void 0 : _d.dimY : 0;
        const weldingHeight = ((_e = manufactureInfo.materialInfoList) === null || _e === void 0 ? void 0 : _e.length) > 0 ? (_f = manufactureInfo.materialInfoList[0]) === null || _f === void 0 ? void 0 : _f.dimZ : 0;
        const netWeight = ((_g = manufactureInfo.materialInfoList) === null || _g === void 0 ? void 0 : _g.length) > 0 ? ((_h = manufactureInfo.materialInfoList[0]) === null || _h === void 0 ? void 0 : _h.netWeight) / 1000 : 0;
        manufactureInfo.netMaterialCost = ((_j = manufactureInfo.materialInfoList) === null || _j === void 0 ? void 0 : _j.length) > 0 ? (_k = manufactureInfo.materialInfoList[0]) === null || _k === void 0 ? void 0 : _k.netMatCost : 0;
        ...
        let lookupListDia = (_p = (_o = this._weldingConfig.getDiscBrushDia()) === null || _o === void 0 ? void 0 : _o.filter((x) => x.materialType === materialType && x.partArea >= crossSectionArea)) === null || _p === void 0 ? void 0 : _p[0];
        if (crossSectionArea > 100001) {
            lookupListDia = (_s = (_r = (_q = this._weldingConfig
        ...
        if (lookupListDia) {
            ...
            deburringRPM = (manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.processTypeID) === ProcessType.WeldingPreparation ? lookupListDia === null || lookupListDia === void 0 ? void 0 : lookupListDia.prepRPM : lookupListDia === null || lookupListDia === void 0 ? void 0 : lookupListDia.cleaningRPM;
        }
        ...
        if (manufactureInfo.iscycleTimeDirty && manufactureInfo.cycleTime != null) {
            ...
            if ((manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.processTypeID) === ProcessType.WeldingCleaning) {
        ...
        if (manufactureInfo.isdirectMachineCostDirty && manufactureInfo.directMachineCost != null) {
            ...
            if (manufactureInfo.directMachineCost != null) {
                directMachineCost = this.shareService.checkDirtyProperty('directMachineCost', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.directMachineCost : directMachineCost;
            }
            manufactureInfo.directMachineCost = directMachineCost;
        }
        if (manufactureInfo.isdirectSetUpCostDirty && manufactureInfo.directSetUpCost != null) {
            ...
            let directSetUpCost = (((Number(manufactureInfo.noOfLowSkilledLabours) * Number(manufactureInfo.setUpTime)) / 60) * Number(manufactureInfo.lowSkilledLaborRatePerHour)) /
                ...
                (((Number(manufactureInfo.noOfSkilledLabours) * Number(manufactureInfo.skilledLaborRatePerHour)) / 60) * Number(manufactureInfo.setUpTime)) /
                    ...
                    Number(manufactureInfo.lotSize);
            if (manufactureInfo.directSetUpCost != null) {
                directSetUpCost = this.shareService.checkDirtyProperty('directSetUpCost', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.setUpCost : directSetUpCost;
            }
            manufactureInfo.directSetUpCost = directSetUpCost;
        }
        if (manufactureInfo.isdirectLaborCostDirty && manufactureInfo.directLaborCost != null) {
            ...
            let directLaborCost = this.shareService.isValidNumber((Number(manufactureInfo.noOfLowSkilledLabours) * Number(manufactureInfo.lowSkilledLaborRatePerHour) * Number(manufactureInfo.cycleTime)) / 3600 / Number(manufactureInfo.efficiency) +
            ...
            if (manufactureInfo.directLaborCost != null) {
                directLaborCost = this.shareService.checkDirtyProperty('directLaborCost', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.directLaborCost : directLaborCost;
            }
            manufactureInfo.directLaborCost = directLaborCost;
        }
        if (manufactureInfo.isinspectionCostDirty && manufactureInfo.inspectionCost != null) {
            ...
            let inspectionCost = this.shareService.isValidNumber(((manufactureInfo.inspectionTime / 60) * Number(manufactureInfo.qaOfInspector) * Number(manufactureInfo.qaOfInspectorRate)) /
                Number(manufactureInfo.efficiency) /
                Number(manufactureInfo.lotSize));
            if (manufactureInfo.inspectionCost != null) {
                inspectionCost = this.shareService.checkDirtyProperty('inspectionCost', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.inspectionCost : inspectionCost;
            }
        ...
        if (manufactureInfo.isyieldPercentDirty && manufactureInfo.yieldPer != null) {
            ...
            if (manufactureInfo.yieldPer != null) {
                yieldPer = this.shareService.checkDirtyProperty('yieldPer', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.yieldPer : yieldPer;
            }
            manufactureInfo.yieldPer = yieldPer;
        }
        if (manufactureInfo.isyieldCostDirty && manufactureInfo.yieldCost != null) {
            ...
            let yieldCost = 0; // this.shareService.isValidNumber((1 - Number(manufactureInfo.yieldPer) / 100) * (Number(manufactureInfo.netMaterialCost) + sum));
            if (manufactureInfo.yieldCost != null) {
                yieldCost = this.shareService.checkDirtyProperty('yieldCost', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.yieldCost : yieldCost;
            }
            manufactureInfo.yieldCost = yieldCost;
        }
    ...
    calculationsForWeldingCleaning(manufactureInfo, fieldColorsList, manufacturingObj) {
        ...
        if (manufactureInfo.isTypeOfOperationDirty && manufactureInfo.typeOfOperationId !== null) {
            ...
            if (manufactureInfo.typeOfOperationId !== null) {
                partType = this.shareService.checkDirtyProperty('typeOfOperationId', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.typeOfOperationId : partType;
            }
        ...
        if (manufactureInfo.isCuttingLengthDirty && manufactureInfo.cuttingLength !== null) {
            ...
            if (manufactureInfo.cuttingLength !== null) {
                totalWeldLength = this.shareService.checkDirtyProperty('cuttingLength', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.cuttingLength : totalWeldLength;
            }
        ...
        let lookupListDia = (_d = (_c = this._weldingConfig.getDiscBrushDia()) === null || _c === void 0 ? void 0 : _c.filter((x) => x.materialType === materialType && x.partArea >= weldCrossSectionalArea)) === null || _d === void 0 ? void 0 : _d[0];
        ...
        if (manufactureInfo.isCuttingLengthDirty && manufactureInfo.noOfWeldPasses !== null) {
            ...
            if (manufactureInfo.noOfWeldPasses !== null) {
                noOfIntermediateStartStops = this.shareService.checkDirtyProperty('noOfWeldPasses', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.noOfWeldPasses : noOfIntermediateStartStops;
            }
        ...
        if (manufactureInfo.isefficiencyDirty && !!manufactureInfo.efficiency) {
            ...
            manufactureInfo.efficiency = this.shareService.checkDirtyProperty('efficiency', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.efficiency : this.shareService.isValidNumber(manufactureInfo.efficiency);
        ...
        if (manufactureInfo.isdirectSetUpCostDirty && manufactureInfo.directSetUpCost !== null) {
            ...
            let directSetUpCost = this.shareService.isValidNumber(((Number(manufactureInfo.machineHourRate) + Number(manufactureInfo.skilledLaborRatePerHour)) * (Number(manufactureInfo.setUpTime) / 60)) / Number(manufactureInfo.lotSize));
            if (manufactureInfo.directSetUpCost !== null) {
                directSetUpCost = this.shareService.checkDirtyProperty('directSetUpCost', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.setUpCost : directSetUpCost;
            }
            manufactureInfo.directSetUpCost = directSetUpCost;
        ...
        if (manufactureInfo.isdirectLaborCostDirty && manufactureInfo.directLaborCost != null) {
            ...
            let directLaborCost = this.shareService.isValidNumber((Number(manufactureInfo.noOfLowSkilledLabours) * Number(manufactureInfo.lowSkilledLaborRatePerHour) * Number(manufactureInfo.cycleTime)) / 3600
            //+(Number(manufactureInfo.noOfSkilledLabours) * Number(manufactureInfo.skilledLaborRatePerHour) * Number(manufactureInfo.cycleTime)) / 3600
            );
            if (manufactureInfo.directLaborCost !== null) {
                directLaborCost = this.shareService.checkDirtyProperty('directLaborCost', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.directLaborCost : directLaborCost;
            }
        ...
        if (manufactureInfo.isinspectionTimeDirty && manufactureInfo.inspectionTime !== null) {
            ...
            let inspectionTime = manufactureInfo.partComplexity == PartComplexity.Low ? 0.25 : manufactureInfo.partComplexity == PartComplexity.Medium ? 0.5 : manufactureInfo.partComplexity == PartComplexity.High ? 1 : 0;
            if (manufactureInfo.inspectionTime !== null) {
                inspectionTime = this.shareService.checkDirtyProperty('inspectionTime', fieldColorsList) ? manufacturingObj === null || manufacturingObj === void 0 ? void 0 : manufacturingObj.inspectionTime : inspectionTime;
            }
            manufactureInfo.inspectionTime = inspectionTime;
        }
        if (manufactureInfo.isinspectionCostDirty && manufactureInfo.inspectionCost !== null) {
            ...
            let inspectionCost = this.shareService.isValidNumber(((((_h = manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.qaOfInspectorRate) !== null && _h !== void 0 ? _h : 0) / 60) * Math.ceil((((_j = manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.samplingRate) !== null && _j !== void 0 ? _j : 0) / 100) * ((_k = manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.lotSize) !== null && _k !== void 0 ? _k : 0)) * ((_l = manufactureInfo === null || manufactureInfo === void 0 ? void 0 : manufactureInfo.inspectionTime) !== null && _l !== void 0 ? _l : 0)) /
        ...
        if (manufactureInfo.isyieldCostDirty && manufactureInfo.yieldCost !== null) {
            ...
            let sum = this.shareService.isValidNumber(Number(manufactureInfo.directMachineCost) + Number(manufactureInfo.directSetUpCost) + Number(manufactureInfo.directLaborCost) + Number(manufactureInfo.inspectionCost));
