...
import { MaterialInsulationJacketMappingService } from '../mapping/material-insulation-jacket-mapping.service';
...
export class MaterialConfigService {
  // coatingGrade = [
  //   { id: 1, grade: 'G360', thickness: 82.3 },
  //   { id: 2, grade: 'G300', thickness: 68.6 },
  //   { id: 3, grade: 'G235', thickness: 53.7 },
  //   { id: 4, grade: 'G210', thickness: 48 },
  //   { id: 5, grade: 'G185', thickness: 42.3 },
  //   { id: 6, grade: 'G165', thickness: 37.7 },
  //   { id: 7, grade: 'G140', thickness: 32 },
  //   { id: 8, grade: 'G115', thickness: 26.3 },
  //   { id: 9, grade: 'G90', thickness: 20.6 },
  //   { id: 10, grade: 'G60', thickness: 13.7 },
  //   { id: 11, grade: 'G40', thickness: 9.1 },
  //   { id: 12, grade: 'G30', thickness: 6.9 },
  // ];
