...
@Component({
  selector: 'app-sheet-metal-process',
  templateUrl: './sheet-metal-process.component.html',
  styleUrl: './sheet-metal-process.component.scss',
  standalone: true,
...
export class SheetMetalProcessComponent {
