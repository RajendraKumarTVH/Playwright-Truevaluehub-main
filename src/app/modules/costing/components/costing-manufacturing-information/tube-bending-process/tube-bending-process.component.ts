...
@Component({
  selector: 'app-tube-bending-process',
  templateUrl: './tube-bending-process.component.html',
  styleUrls: ['./tube-bending-process.component.scss'],
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, FieldCommentComponent, OnlyNumber, AutoTooltipDirective],
})
export class TubeBendingProcessComponent {
