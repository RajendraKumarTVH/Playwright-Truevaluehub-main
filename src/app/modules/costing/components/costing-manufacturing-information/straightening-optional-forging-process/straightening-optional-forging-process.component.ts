...
@Component({
  selector: 'app-straightening-optional-forging-process',
  ...
  templateUrl: './straightening-optional-forging-process.component.html',
  styleUrl: './straightening-optional-forging-process.component.scss',
  standalone: true,
})
export class StraighteningOptionalForgingProcessComponent {
