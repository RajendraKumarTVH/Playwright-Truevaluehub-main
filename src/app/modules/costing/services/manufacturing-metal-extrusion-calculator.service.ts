...
export class ManufacturingMetalExtrusionCalculatorService {
  ...
  public doCostCalculationsForMetalTubeExtrusion(manufactureInfo: ProcessInfoDto, fieldColorsList: any, manufacturingObj: ProcessInfoDto): ProcessInfoDto {
    ...
    //   if (processTypeID === ProcessType.MetalTubeExtrusion) {
    //     theoreticalForce = this.shareService.isValidNumber((((3.14 * Math.pow(inputBilletDiameter, 2) / 4) *
    //       ultimateTensileStrength * Math.log(Math.pow(inputBilletDiameter, 2) / Math.pow(envelopeWidth, 2))) / Math.pow(10, 6)) * 100);
    //   }
    ...
    // } else {
    //   let directSetUpCost = (Number(manufactureInfo.noOfLowSkilledLabours) * Number(manufactureInfo.setUpTime) / 60 * Number(manufactureInfo.lowSkilledLaborRatePerHour) / Number(manufactureInfo.efficiency) / Number(manufactureInfo.lotSize)) + (Number(manufactureInfo.noOfSkilledLabours) * Number(manufactureInfo.skilledLaborRatePerHour) / 60 * Number(manufactureInfo.setUpTime) / Number(manufactureInfo.efficiency) / Number(manufactureInfo.lotSize));
    ...
    // } else {
    //   let inspectionCost = this.shareService.isValidNumber(manufactureInfo.inspectionTime * Number(manufactureInfo.qaOfInspectorRate) / 60 / Number(manufactureInfo.efficiency) / Number(manufactureInfo.lotSize));
    ...
    //   Number(manufactureInfo.directMachineCost) + Number(manufactureInfo.directSetUpCost) +
    //   Number(manufactureInfo.directLaborCost) + Number(manufactureInfo.inspectionCost)
    // );
